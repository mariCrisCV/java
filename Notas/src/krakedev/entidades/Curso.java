...
public class Curso {
	...
	public double calcularPromedioCurso() {
		...
		promedioCurso=sumaTotal/estudiantes.size();
	...
	public void mostrar() {
		...
		for(int i=0; i<estudiantes.size();i++) {
			elementoEstudiante=estudiantes.get(i);
			System.out.println("Estudiantes [Nombre: "+estudiantes.get(i).getNombre()+" "+estudiantes.get(i).getApellido()+ " Cedula: "+estudiantes.get(i).getCedula()+ "]");
		}
	}
